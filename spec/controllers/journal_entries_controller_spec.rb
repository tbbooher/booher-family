  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved journal_entry as @journal_entry" do
        ...
        post :create, {:journal_entry => { "entry_date" => "invalid value" }}, valid_session
        assigns(:journal_entry).should be_a_new(JournalEntry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested journal_entry" do
        ...
        JournalEntry.any_instance.should_receive(:update_attributes).with({ "entry_date" => "2012-12-28" })
        put :update, {:id => journal_entry.to_param, :journal_entry => { "entry_date" => "2012-12-28" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the journal_entry as @journal_entry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        JournalEntry.any_instance.stub(:save).and_return(false)
        put :update, {:id => journal_entry.to_param, :journal_entry => { "entry_date" => "invalid value" }}, valid_session
        assigns(:journal_entry).should eq(journal_entry)
      end
